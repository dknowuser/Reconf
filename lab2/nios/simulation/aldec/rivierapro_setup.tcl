...
# ACDS 12.1sp1 243 win32 2020.10.10.18:17:43
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/nios_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_id_router_001.sv"                         -work id_router_001                                                                    
  vlog  "$QSYS_SIMDIR/submodules/nios_id_router.sv"                             -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/submodules/nios_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlog  "$QSYS_SIMDIR/submodules/nios_addr_router.sv"                           -work addr_router                                                                      
  ...
  vlog  "$QSYS_SIMDIR/submodules/nios_pio_0.v"                                  -work pio_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/nios_onchip_memory2_0.v"                       -work onchip_memory2_0                                                                 
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_sysclk.v"  -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_tck.v"     -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_wrapper.v" -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_oci_test_bench.v"            -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_test_bench.v"                -work nios2_qsys_0                                                                     
  vlog  "$QSYS_SIMDIR/nios.v"                                                                                                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_001 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_001 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L pio_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
