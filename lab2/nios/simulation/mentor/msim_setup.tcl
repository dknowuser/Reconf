...
# ACDS 12.1sp1 243 win32 2020.10.10.18:17:34
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/nios_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux_001                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/nios_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/nios_id_router_001.sv"                         -work id_router_001                                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/nios_id_router.sv"                             -work id_router                                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/nios_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlog -sv "$QSYS_SIMDIR/submodules/nios_addr_router.sv"                           -work addr_router                                                                      
