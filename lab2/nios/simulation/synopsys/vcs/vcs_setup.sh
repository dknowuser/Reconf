...
# ACDS 12.1sp1 243 win32 2020.10.10.18:17:36
...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/nios_rsp_xbar_mux_001.sv \
  $QSYS_SIMDIR/submodules/nios_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/nios_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/nios_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/nios_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/nios_id_router_001.sv \
  $QSYS_SIMDIR/submodules/nios_id_router.sv \
  $QSYS_SIMDIR/submodules/nios_addr_router_001.sv \
  $QSYS_SIMDIR/submodules/nios_addr_router.sv \
  ...
  $QSYS_SIMDIR/submodules/nios_pio_0.v \
  $QSYS_SIMDIR/submodules/nios_onchip_memory2_0.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_sysclk.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_tck.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_wrapper.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_oci_test_bench.v \
  $QSYS_SIMDIR/submodules/nios_nios2_qsys_0_test_bench.v \
  $QSYS_SIMDIR/nios.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
