...
# ACDS 12.1sp1 243 win32 2020.10.10.18:17:38
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux_001                                                                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_id_router_001.sv"                         -work id_router_001                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_id_router.sv"                             -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/nios_addr_router.sv"                           -work addr_router                                                                      
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_pio_0.v"                                  -work pio_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_onchip_memory2_0.v"                       -work onchip_memory2_0                                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_sysclk.v"  -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_tck.v"     -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_jtag_debug_module_wrapper.v" -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_oci_test_bench.v"            -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/nios_nios2_qsys_0_test_bench.v"                -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/nios.v"                                                                                                                                          
fi
